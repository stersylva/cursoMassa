...
public class ContaServicoTest {
	...
	public static void banco() throws Exception {
		...
		conn.createStatement().executeUpdate("INSERT INTO contas (id, nome, usuario_id)"
				+ "VALUES(1, 'conta para alterar', 1),(2, 'conta para consultar', 1),(3, 'conta para deletar', 1) ");
	}
	...
	public void testAlterar() throws Exception {
		...
		contaService.printAll();
		contaTest.setNome("conta alterada555");
		Conta contaAlterada = contaService.salvar(contaTest);
		Assert.assertEquals("conta alterada555", contaAlterada.getNome());
		contaService.printAll();
	}
	
	@Test
	public void testConsultar() throws Exception {
		Conta contaBuscada = contaService.findById(2L);
		Assert.assertEquals("conta para consultar", contaBuscada.getNome());	
	}
	
	@Test
	public void testDeletar() throws Exception {
		Conta contaTest = contaService.findByName("conta para deletar");
		contaService.printAll();
